...
with open("/blob/kmsw0eastau/data/hrrr/Nwp_loss_file/variance_dict_lt1_4569.pkl", "rb") as f:
...
plot_based_acc_2_1_2(var_mapping, atmos_level, mean_dict, variance_dict, "6mouth_all_var")
...
for var_name_HRRR in var_mapping.keys():
    ...
    plot_based_acc_2_1_2(var_mapping_single, atmos_level, mean_dict, variance_dict, "6mouth_"+var_mapping[var_name_HRRR])
